...
test.describe('Cadastro de produtos', () => {
  ...
  test('Excluir um produto com sucesso', async ({ Given, When, Then, And, page, produtoCriado, request }) => { 
    await Given('que existe um produto "Mouse" cadastrado', null, { produtoCriado, request }); 
    await And('acesso a tela de produtos', null, { page }); 
    await When('clico no botao Remover do produto "Mouse"', null, { page, produtoCriado }); 
    await Then('o produto "Mouse" nao aparece mais na listagem de produtos', null, { page, produtoCriado }); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":26,"pickleLine":21,"tags":[],"steps":[{"pwStepLine":27,"gherkinStepLine":22,"keywordType":"Context","textWithKeyword":"Given que existe um produto \"Mouse\" cadastrado","stepMatchArguments":[{"group":{"start":22,"value":"\"Mouse\"","children":[{"start":23,"value":"Mouse","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":28,"gherkinStepLine":23,"keywordType":"Context","textWithKeyword":"And acesso a tela de produtos","stepMatchArguments":[]},{"pwStepLine":29,"gherkinStepLine":24,"keywordType":"Action","textWithKeyword":"When clico no botao Remover do produto \"Mouse\"","stepMatchArguments":[{"group":{"start":34,"value":"\"Mouse\"","children":[{"start":35,"value":"Mouse","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":30,"gherkinStepLine":25,"keywordType":"Outcome","textWithKeyword":"Then o produto \"Mouse\" nao aparece mais na listagem de produtos","stepMatchArguments":[{"group":{"start":10,"value":"\"Mouse\"","children":[{"start":11,"value":"Mouse","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]}]},
]; // bdd-data-end